...
import { PrismaArticleRepository } from '../infrastructure/repositories/article.repository';
import { PrismaArticleAuthorRepository } from '../infrastructure/repositories/articleAuthor.repository';
import { PrismaArticleAttachmentRepository } from '../infrastructure/repositories/articleAttachment.repository';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: ArticleAuthorRepository,
      useClass: PrismaArticleAuthorRepository,
    },
    {
      provide: ArticleAttachmentRepository,
      useClass: PrismaArticleAttachmentRepository,
    },
  ],
  exports: [
    ArticleRepository,
